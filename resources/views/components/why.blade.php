...
<section class="py-12 bg-gray-50">
    <div class="container text-center ">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Card 1 -->
            <div class="flex items-start border rounded-lg p-4 shadow-md bg-white w-full">
                <!-- Icon -->
                ...
                <!-- Text Content -->
                <div class="text-left">
                    <h3 class="text-xl font-semibold text-gray-900">250+</h3>
            ...
            <div class="flex items-start border rounded-lg p-4 shadow-md bg-white w-full">
                ...
                <!-- Text Content -->
                <div class="text-left">
                    <h3 class="text-xl font-semibold text-gray-900">600+</h3>
            ...
            <div class="flex items-start border rounded-lg p-4 shadow-md bg-white w-full">
                ...
                <!-- Text Content -->
                <div class="text-left">
                    <h3 class="text-xl font-semibold text-gray-900">1.8K+</h3>
            ...
            <div class="flex items-start border rounded-lg p-4 shadow-md bg-white w-full">
                ...
                <!-- Text Content -->
                <div class="text-left">
                    <h3 class="text-xl font-semibold text-gray-900">11K+</h3>
