    ...
    <div
            ...
            <div class="relative">
                ...
                <div class="absolute left-0 mt-2 w-48 bg-white border rounded-md shadow-lg dropdown-menu hidden"
                    ...
                    <a href="/profile-tenagaahli"
                        class="block px-4 py-2 text-gray-700 hover:text-[#FC6C3F] hover:bg-gray-100">Tenaga
                        Struktural</a>
                </div>
            </div>
        ...
        <div class="flex items-center ">
            <a href="#" class="hidden lg:flex">
                <div
                    class="hidden contact-button custom-1280:flex items-center lg:p-2 bg-[#FC6C3F] text-white rounded-xl shadow-lg">
    ...
    <div class="lg:hidden hidden  bg-white inset-x-0 w-full" id="mobile-menu">
        <nav class="md:mx-2 pt-2 pb-4 space-y-1 max-h-[70vh] overflow-y-auto border-b-2 rounded-b-md border-[#FC6C3F]">
            ...
            <div class="px-3 py-2 hidden" id="mobile-dropdown" data-aos="fade-down">
                ...
                <a href="/profile-tenagaahli"
                    class="block text-gray-700 hover:bg-gray-100 rounded-md px-3 py-2">Tenaga
                    Struktural</a>
            </div>
            ...
            <div class="flex items-center justify-center bg-[#FC6C3F] mx-24 mt-4 text-white rounded-xl shadow-lg p-2">
                <img src="{{ asset('Image/icon/Contact Us.png') }}" alt="Phone Icon" class="h-auto">
            </div>
