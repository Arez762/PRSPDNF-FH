    ...
    <div class="carousel scrollbar-hide flex w-full snap-x snap-mandatory gap-4 overflow-x-scroll scroll-smooth">
        <div
            ...
            <div class="absolute inset-0">
                <img src="{{ asset('Image/prspdnf/galeri-6.JPG') }}" alt="Gallery Image"
            ...
            <div class="absolute inset-0 flex flex-col items-start justify-end p-4 text-justify">
                <h2 class="text-sm lg:text-2xl font-bold text-white mb-2">Judul Card</h2>
                <p class="text-xs lg:text-sm text-white mb-4">
                    Ini adalah deskripsi singkat tentang gambar atau konten yang ada di card ini. Deskripsinya bisa
                    dibuat lebih panjang atau pendek sesuai kebutuhan.
                </p>
                <a href="#"
        ...
        <!-- Repeat the above structure for other cards, with lazy loading and transition applied to each image -->
        <div
            class="relative aspect-[1/1] w-[85%] shrink-0 snap-start snap-always rounded-xl bg-blue-200 md:w-[calc(33.33%-(32px/3))] shadow-lg overflow-hidden">
            <div class="absolute inset-0">
                <img src="{{ asset('Image/prspdnf/galeri-6.JPG') }}" alt="Gallery Image"
...
<script>
    ...
    const autoScrollInterval = 3000; // Interval waktu dalam milidetik untuk scroll otomatis
    let autoScroll;
