<footer class="bg-[#697077] dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="mb-6 md:mb-0">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse lg:mb-8">
                <img src="{{ asset('icon/Logo PRSPDNF FH.png') }}" class="h-12" alt="PRSPDNF Logo" />
                <div>
                    <span class="flex lg:text-sm uppercase text-white ">PRSPDNF</span>
                    <span class="flex lg:text-lg font-semibold text-white ">Fajar Harapan</span>
                </div>
            </a>
        ...
        <div class="flex flex-col md:flex-row md:justify-between">
            ...
            <div class="relative w-full h-48 lg:w-64 lg:h-64 my-4">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4 mt-4 md:mt-0 md:ml-8 text-left">
                <div>
