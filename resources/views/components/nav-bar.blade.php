    ...
    <div
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <button data-collapse-toggle="navbar-dropdown" type="button"
                class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-[#FC6C3F] dark:focus:ring-gray-600"
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul
                ...
                <li>
                    <a href="/"
                        class="block py-2 px-3 text-text-gray-900 text-gray-900 bg-gray-100 rounded md:bg-transparent md:p-0 md:dark:text-orange-500 dark:bg-orange-600 md:dark:bg-transparent"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                            ...
                            <li>
                                <a href="/pelayanan-persyaratan"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Persyaratan
                                    Umum & Administrasi</a>
                            </li>
                            <li>
                                <a href="/pelayanan-alur"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Alur
                                    Pelayanan</a>
                            </li>
                            {{-- <li>
                            <a href="#"
