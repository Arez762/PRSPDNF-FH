<div class="flex flex-col lg:flex-row items-center bg-[#5959CD] rounded-lg mx-6 lg:mx-40 mb-12">
    ...
    <div class="lg:w-1/2 w-full text-white rounded-lg lg:px-12 p-6 lg:py-0">
        ...
        <h1 class="text-2xl lg:text-3xl font-bold text-center lg:text-left my-6">
            Tunggu apalagi? <br> <span class="text-orange-400">Segera bergabung</span> bersama keluarga besar kami sekarang dan rasakan perubahan yang terjadi di hidup Anda!
        </h1>
