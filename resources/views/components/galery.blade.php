{{-- <section class="container p-4 py-16 flex flex-col justify-center items-center min-h-screen">

    <div class="lg:bg-white lg:px-12 lg:py-8">
        ...
        <!-- Grid gambar di tengah -->
        <div class="grid grid-cols-4 gap-4">
            <!-- Left Column with stacked images and animation -->
            <div class="col-span-1 flex flex-col space-y-4 animated-images">
                <img src="https://via.placeholder.com/150" alt="Image 1"
                    class="w-full h-36 rounded-lg object-cover animate-up">
            ...
            <div class="col-span-1 flex flex-col space-y-4 mt-20 animated-images">
                <img src="https://via.placeholder.com/150" alt="Image 1"
                    class="w-full h-36 rounded-lg object-cover animate-up">
                <img src="https://via.placeholder.com/150" alt="Image 2"
                    class="w-full h-36 rounded-lg object-cover animate-up">
