    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="container mx-auto p-6 flex flex-wrap justify-center">
            ...
            <div class="bg-white rounded-lg shadow-lg m-4 w-80 transform transition duration-300 hover:scale-105">
                <img src="https://via.placeholder.com/300x150" alt="Visi dan Misi"
                ...
                <div class="p-6">
                    ...
                    <p class="text-[#21272A] mb-6">Egestas elit dui scelerisque eu et purus aliquam vitae habitasse...
                    </p>
            ...
            <!-- Card 2 -->
            <div class="bg-white rounded-lg shadow-lg m-4 w-80 transform transition duration-300 hover:scale-105">
                <img src="https://via.placeholder.com/300x150" alt="Sejarah"
                    class="rounded-t-lg w-full h-40 object-cover">
                <div class="p-4">
                    <h4 class="text-lg text-[#FC6C3F] font-semibold mb-2">Profile</h4>
            ...
            <!-- Card 3 -->
            <div class="bg-white rounded-lg shadow-lg m-4 w-80 transform transition duration-300 hover:scale-105">
                <img src="https://via.placeholder.com/300x150" alt="Tenaga Ahli"
                    class="rounded-t-lg w-full h-40 object-cover">
                <div class="p-6">
                    <h4 class="text-lg text-[#FC6C3F] font-semibold mb-2">Profile</h4>
