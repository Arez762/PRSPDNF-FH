...
<body class="bg-[#F3F4F8] font-poppins flex flex-col min-h-screen">
    ...
    <div class="container">
        <div class="h-auto w-full flex flex-col justify-start items-center">
            <div class="bg-white border-2 border-[#FC6C3F] rounded-lg px-4 py-6 mb-10 lg:w-2/4 mt-12 m-4 justify-start items-center"
                data-aos="fade">
            ...
            <div class="border-2 border-[#FC6C3F] py-3 px-8 rounded-lg shadow-lg justify-start items-center "
                data-aos="fade-up">
        ...
        <div class="flex flex-col md:grid grid-cols-9 mx-auto lg:mx-32 p-2 text-blue-50">
            ...
            <div class="flex flex-row-reverse md:contents">
                <div class="bg-white col-start-1 col-end-5 p-8 rounded-xl my-4 ml-auto border-2 border-[#FC6C3F] shadow-lg"
                    data-aos="fade-up">
            ...
            <div class="flex md:contents">
                ...
                <div class="bg-white col-start-6 col-end-10 p-8 rounded-xl my-4 mr-auto border-2 border-[#FC6C3F] shadow-lg"
                    data-aos="fade-up">
        ...
        <div class="flex flex-col md:grid grid-cols-9 mx-auto lg:mx-32 p-2 text-blue-50">
            <div class="flex flex-row-reverse md:contents">
                ...
                <div class="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    <div class="h-full w-6 flex items-center justify-center">
                        <div
                            class="h-full w-1 bg-[#FC6C3F] pointer-events-none shadow-[0_10px_10px_-5px_rgba(252,108,63,0.5)]">
                        </div>
                    </div>
                    <div class="w-6 h-6 absolute top-1/2 -mt-3 rounded-full bg-[#FC6C3F] shadow"></div>
                </div>
        ...
        <div class="h-auto w-full flex flex-col justify-start items-center">
            <div class="bg-white border-2 border-[#FC6C3F] rounded-lg px-4 py-6 mb-10 lg:w-2/4 mt-10 m-4 justify-start items-center"
                data-aos="fade">
                <h2 class="text-[#FC6C3F] text-center lg:text-2xl text-xl font-bold mb-4">Terus Berkembang Hingga Saat Ini</h2>
                <p class="text-center text-gray-700 lg:text-base text-sm">
                    Fajar Harapan didirikan dengan tujuan mulia untuk mendukung penyandang disabilitas dalam mencapai
                    kemandirian dan kualitas hidup yang lebih baik. Sejak awal berdiri, panti ini telah berkomitmen
                    untuk memberikan layanan rehabilitasi yang komprehensif, pendidikan inklusif, dan program
